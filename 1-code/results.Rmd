...
It is now straightforward to predict the wood dry biomass at different scales using our model.
...
results = res$data%>%
  mutate(volume = length * cross_section,
         volume_pred = length * pred_cross_section_cor,
...
results%>%
  ...
  geom_abline(slope = 1, intercept = 0)+
  labs(color = "Tree, branch", y = "Predicted dry mass (g)",
       x = "Observed dry mass (g)")
```
